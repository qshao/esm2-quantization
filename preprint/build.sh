...
tar --format=ustar -czf arxiv-submission.tar.gz "$DOC.tex" fig_tail.pdf fig_fidelity.pdf fig_pareto.pdf fig_scale.pdf fig_dominance.pdf fig_w8a8.pdf fig_snr.pdf
