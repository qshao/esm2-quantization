...
Build: `./build.sh` → `esm2_quantization.pdf` (34 pp) and `arxiv-submission.tar.gz` (378 KB).
...
- Compiles standalone from the tarball alone — extracted to a clean directory
  and built with no access to this repo: 34 pages, **no undefined references or
  citations**.
