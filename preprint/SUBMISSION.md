...
Build: `./build.sh` → `esm2_quantization.pdf` (30 pp) and `arxiv-submission.tar.gz` (272 KB).
...
- Compiles standalone from the tarball alone — extracted to a clean directory
  and built with no access to this repo: 30 pages, **no undefined references or
  citations**.
