...
650M in bf16 while being less accurate and $20\times$ slower. We also report
four measurement artifacts encountered during this study, three of which
inverted the result they were meant to measure.
\end{abstract}
...
Bulk embedding (A100)  & throughput & \cfg{int8\_wo}; \cfg{int8\_dyn} costs real accuracy \\
...
\begin{itemize}\setlength{\itemsep}{2pt}
  ...
  \item \textbf{Avoid \cfg{int8\_dyn} and \cfg{int4\_wo} for variant-effect work
        at any scale.} They are not trade-offs: both are slower than the best
        option in this regime \emph{and} own the two worst tails we measured,
        $-0.37$ and $-0.20$.
\end{itemize}
