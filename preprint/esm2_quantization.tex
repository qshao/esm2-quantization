...
\noindent
\textcolor{red}{[TODO before submission: insert the public repository or archive
DOI here. arXiv permits a URL in this section; a Zenodo DOI is preferable for
the per-variant score files, which total roughly 90\,MB compressed.]}
